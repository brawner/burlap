...
// *
// */
//public class ImmObjectInstance extends ObjectInstance{
//	
//	/**
...
//	 */
//	public ImmObjectInstance(ObjectClass obClass, String name){
//		super(obClass, name);
//	}
//	
//	/**
...
//	 */
//	public ImmObjectInstance(ImmObjectInstance o){
//		super(o);	
//	}
//	
//	public ImmObjectInstance(ObjectInstance o) {
//		super(o);
//	}
//	
//	public ImmObjectInstance(ObjectClass obClass, String name, List<Value> values) {
//		super(obClass, name, values);
//	}
//	
//	
//	/**
...
//	 */
//	public ImmObjectInstance copy(){
//		return new ImmObjectInstance(this);
//	}
//	
//	
//	
...
//	
//	
//	public ImmObjectInstance replaceName(String name){
//		return new ImmObjectInstance(this.obClass, name, this.values);
//	}
//	
//	/**
...
//	}
//	
//	public ImmObjectInstance changeValue(String attName, String v){
...
//		return new ImmObjectInstance(this.obClass, this.name, values);
//	}
//	
//	/**
...
//	}
//	
//	public ImmObjectInstance changeValue(String attName, double v){
//		List<Value> values = new ArrayList<Value>(this.values);
//		int ind = obClass.attributeIndex(attName);
//		Value value = values.get(ind);
//		values.set(ind, value.changeValue(v));
...
//	}
//	
//	public ImmObjectInstance changeValue(String attName, int v){
//		List<Value> values = new ArrayList<Value>(this.values);
//		int ind = obClass.attributeIndex(attName);
//		Value value = values.get(ind);
//		values.set(ind, value.changeValue(v));
...
//	}
//	
//	public ImmObjectInstance changeValue(String attName, boolean v){
//		List<Value> values = new ArrayList<Value>(this.values);
//		int ind = obClass.attributeIndex(attName);
//		Value value = values.get(ind);
//		values.set(ind, value.changeValue(v));
...
//	
//	
//	public ImmObjectInstance appendRelationalTarget(String attName, String target){
//		List<Value> values = new ArrayList<Value>(this.values);
//		int ind = obClass.attributeIndex(attName);
//		Value value = values.get(ind);
...
//	}
//	
//	public ImmObjectInstance appendRelationalTarget(String attName, Collection<String> targets){
//		List<Value> values = new ArrayList<Value>(this.values);
//		int ind = obClass.attributeIndex(attName);
//		Value value = values.get(ind);
...
//	}
//	
//	public ImmObjectInstance removeAllRelationalTarget(String attName){
//		List<Value> values = new ArrayList<Value>(this.values);
//		int ind = obClass.attributeIndex(attName);
//		Value value = values.get(ind);
...
//	}
//	
//	public ImmObjectInstance replaceRelationalTarget(String attName){
//		List<Value> values = new ArrayList<Value>(this.values);
//		int ind = obClass.attributeIndex(attName);
//		Value value = values.get(ind);
//		values.set(ind, value.replaceRelationalTarget(attName));
//		return new ImmObjectInstance(this.obClass, this.name, values);
//	}
//	
//	/**
...
//		}
//		
//		ImmObjectInstance op = (ImmObjectInstance)obj;
...
//	 */
//	public boolean valueEquals(ImmObjectInstance obj){
//		if (!this.equals(obj)) {
//			return false;
//		}
//	
