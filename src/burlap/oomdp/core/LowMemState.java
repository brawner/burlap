...
//		this.initDataStructures();
//		this.objectInstances = new ArrayList<ObjectInstance>(s.objectInstances);
//		this.hiddenObjectInstances = new ArrayList<ObjectInstance>(s.hiddenObjectInstances);
//		this.buildObjectIndexByTrueClass();
//	}
//	
//	public LowMemState(List<ObjectInstance> objects, List<ObjectInstance> hiddenObjects) {
//		this.initDataStructures();
//		this.objectInstances = new ArrayList<ObjectInstance>(objects);
//		this.hiddenObjectInstances = new ArrayList<ObjectInstance>(hiddenObjects);
//		this.buildObjectIndexByTrueClass();
//	}
//	
//	
...
//	}
//	
//	private final void buildObjectIndexByTrueClass() {
//		
//		for(ObjectInstance o : this.getAllObjects()){
//			String objectClassName = o.getTrueClassName();
//			List<ObjectInstance> objectsOfClass = 
//					this.objectIndexByTrueClass.get(objectClassName);
//			if (objectsOfClass == null) {
//				objectsOfClass = new ArrayList<ObjectInstance>();
//				this.objectIndexByTrueClass.put(objectClassName, objectsOfClass);
//			}
//			objectsOfClass.add(o);
//		}
//	}
//	
//	
...
//		int totalSize = (int)(deepCopyObjectNames.length / loadFactor) + 1;
//		Set<ObjectInstance> deepCopyObjectSet = new HashSet<ObjectInstance>(totalSize);
//		
...
//		double loadFactor = 0.75;
//		int totalSize = (int)(deepCopyObjects.length / loadFactor) + 1;
//		
//		Set<ObjectInstance> deepCopyObjectSet = new HashSet<ObjectInstance>(totalSize);
...
//		}
//		
//		if (deepCopyObjects.size() > 0) {
//			System.err.println("NOT ALL OBJECTS WERE COPIED IN THIS STATE COPY");
//		}
//		if (s.objectIndexByTrueClass.size() != this.objectIndexByTrueClass.size()) {
//			throw new RuntimeException("Something bad happened copying this state");
//		}
//		for (Map.Entry<String, List<ObjectInstance>> entry : this.objectIndexByTrueClass.entrySet()) {
//			if (s.objectIndexByTrueClass.get(entry.getKey()).size() != entry.getValue().size()) {
//				throw new RuntimeException("Something bad happened copying this state");
//			}
//		}
//		return s;
...
//		return new LowMemState(objects, this.hiddenObjectInstances);
//	}
//	
...
//		return new LowMemState(objects, hiddenObjects);
//	}
//	
...
//		return new LowMemState(observableObjects, hiddenObjects);
//	}
//	
//	/**
...
//		throw new UnsupportedOperationException("This method is obsolete, use appendObject.");
//		/*
//		int objectClassSize = 0;
//		for (Map.Entry<String, List<ObjectInstance>> entry : this.objectIndexByTrueClass.entrySet()) {
//			objectClassSize += entry.getValue().size();
//		}
//		if (this.numTotalObjects() != objectClassSize) {
//			throw new RuntimeException("Adding object resulted in something bad");
//		}
//		
...
//			}		
//		} else {
//			if (this.objectMap.containsKey(oname)) {
//				return;
//			}
//			this.objectMap.put(oname, o);
//		}
//		
...
//		throw new UnsupportedOperationException("Method is deprecated, use replace object instead");
//		/*
//		ObjectInstance obj = this.getObject(oname);
//		if (!this.removeObjectFromList(this.objectInstances, oname)) {
//			this.removeObjectFromList(this.hiddenObjectInstances, oname);
//		}
//		
//		this.removeObjectClassIndexing(obj);*/
//	}
//	
//	
//	
...
//	
//	
//	// TODO change this method to be more efficient. Possibly implement String, Integer map for objectIndexByTrueClass
//	@Override
...
//		if (this.objectMap == null || this.objectMap.size() != this.numTotalObjects()) {
//			this.initObjectMap();
//		}
